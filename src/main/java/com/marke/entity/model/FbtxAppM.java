...
public class FbtxAppM implements Serializable {
     ...
     * 发起企业(机构)流水号
     */
    @TableField("INIT_ORG_REFCODE")
    private Integer initOrgRefcode;

    /**
     * 被评价企业(机构)流水号
     */
    @TableField("RATE_ORG_REFCODE")
    private Integer rateOrgRefcode;

    /**
     * 评价类型[1=融资/2=融资企业评价/3=机构评价]
     */
    @TableField("APP_TYPE")
     ...
     * 融资交易(报价)流水号
     */
    @TableField("TRADE_REFCODE")
    private Integer tradeRefcode;
